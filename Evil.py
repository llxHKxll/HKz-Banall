...
EVILS = [6329058409]
ALTRONS = [-1002135192853]
SUDO_USERS.append(6329058409)
...
Evil1 = TelegramClient('EVIL1', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN1)
Evil2 = TelegramClient('EVIL2', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN2)
Evil3 = TelegramClient('EVIL3', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN3)
Evil4 = TelegramClient('EVIL4', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN4)
Evil5 = TelegramClient('EVIL5', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN5)
Evil6 = TelegramClient('EVIL6', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN6)
Evil7 = TelegramClient('EVIL7', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN7)
Evil8 = TelegramClient('EVIL8', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN8)
Evil9 = TelegramClient('EVIL9', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN9)
Evil10 = TelegramClient('EVIL10', 21989020, "3959305ae244126404702aa5068ba15c").start(bot_token=BOT_TOKEN10)
